...
class TestX1LexemeAnnotate(unittest.TestCase):
    ...
    def test_x1_lexeme_main_dwug_en(self):
            # call the function to be tested
            lexeme_main(self.usage_dir_test_dwug_en, self.custom_dir,self.custom_filename,self.prefix,self.debug,self.subword_aggregation,self.prediction_type)
    ...
    def test_x1_lexeme_main_dwug_de(self):
            # call the function to be tested
            lexeme_main(self.usage_dir_test_dwug_de, self.custom_dir,self.custom_filename,self.prefix,self.debug,self.subword_aggregation,self.prediction_type)
            # check that the output file was created
    ...
    def test_x1_lexeme_main_dwug_sv(self):
            # call the function to be tested
            lexeme_main(self.usage_dir_test_dwug_sv, self.custom_dir,self.custom_filename,self.prefix,self.debug,self.subword_aggregation,self.prediction_type)
            # check that the output file was created
    ...
    def test_x1_lexeme_main_tempowic_train(self):
            # call the function to be tested
            lexeme_main(self.usage_dir_test_tempowic_train, self.custom_dir,self.custom_filename,self.prefix,self.debug,self.subword_aggregation,self.prediction_type)
            # check that the output file was created
    ...
    def test_x1_lexeme_main_tempowic_trial(self):
            # call the function to be tested
            lexeme_main(self.usage_dir_test_tempowic_trial, self.custom_dir,self.custom_filename,self.prefix,self.debug,self.subword_aggregation,self.prediction_type)
            # check that the output file was created
    ...
    def test_x1_lexeme_main_tempowic_validation(self):
            # call the function to be tested
            lexeme_main(self.usage_dir_test_tempowic_validation, self.custom_dir,self.custom_filename,self.prefix,self.debug,self.subword_aggregation,self.prediction_type)
            # check that the output file was created
