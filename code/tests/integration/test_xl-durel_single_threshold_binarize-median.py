...
def suite():
    ...
    test_suite.addTest( CustomTestAnAnnotator('test_xl_durel_main_dwug_en'))
    test_suite.addTest( CustomTestAnAnnotator('test_xl_durel_main_dwug_de'))
    test_suite.addTest( CustomTestAnAnnotator('test_xl_durel_main_dwug_sv'))
