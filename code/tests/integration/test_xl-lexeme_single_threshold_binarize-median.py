...
class TestAnAnnotator(unittest.TestCase):
    ...
    def test_xl_lexeme_main_dwug_de(self):
        ...
        acc,corr,pvalue = evaluate(self.custom_dir,self.custom_filename,self.usage_dir_test_dwug_de, self.thresholds,self.debug,dataset='dwug_de_transformed_binarize-median')
