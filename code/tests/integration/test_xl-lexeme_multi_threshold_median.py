...
class TestAnAnnotator(unittest.TestCase):
    def setUp(self):
        ...
        self.usage_dir_test_en_arm = test_data_directory_path + 'testwug_en_transformed_median/data_split/arm/'
        self.usage_dir_test_en_target = test_data_directory_path + 'testwug_en_transformed_median/data_split/target/'
